...
Intern* OfficeBlock::getIntern() { return this->_intern; }
Bureaucrat* OfficeBlock::getSigner() { return this->_signer; }
Bureaucrat* OfficeBlock::getExecutor() { return this->_executor; }
...
void OfficeBlock::doBureaucracy(std::string const &target, std::string const &name) {
	...
	if (!ptf)
		throw OfficeBlock::UnknownBlankException(ptf);
...
OfficeBlock::UnknownBlankException::UnknownBlankException(Form *ptf) : exception() { delete ptf; }
