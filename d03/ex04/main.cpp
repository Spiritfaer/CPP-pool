...
int 	main(void)
{
	...
	std::cout << "-------------------------------" << std::endl;
	SuperTrap	bot_4;
	bot_4.rangedAttack("The san");
	bot_4.vaulthunter_dot_exe("Dron-1000-T");
	bot_4.vaulthunter_dot_exe("Jack");

	bot_4.takeDamage(150);
	bot_4.beFatigue();
	bot_4.beFatigue();
	bot_4.beWait();
	bot_4.meleeAttack("BANANA");
	bot_4.rangedAttack("BANANA");
	std::cout << "-------------------------------" << std::endl;
